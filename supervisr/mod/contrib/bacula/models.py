...
class File(models.Model):
    ...
    FileIndex = models.IntegerField(db_column='FileIndex', blank=True, null=True)
    JobId = models.IntegerField(db_column='JobId')
    PathId = models.ForeignKey('Path', db_column='PathId', on_delete=models.CASCADE)
    FilenameId = models.ForeignKey('Filename', db_column='FilenameId', on_delete=models.CASCADE)
...
class Job(models.Model):
    ...
    Pool = models.ForeignKey('Pool', db_column='PoolId',
                             blank=True, null=True, on_delete=models.CASCADE)
