...
urlpatterns = [
    ...
    # Reverse Zones
    url(r'^zones/reverse/$',
        reverse_zones.ReverseZoneIndexView.as_view(), name='reverse-zone-index'),
    # Records
    ...
    url(r'^records/set/(?P<record_uuid>%s)/$' % UUID_REGEX,
        records.SetRecordView.as_view(), name='record-set-view'),
    url(r'^records/(?P<record_uuid>%s)/update/$' % UUID_REGEX,
        records.RecordUpdateView.as_view(), name='record-update'),
    url(r'^records/(?P<record_uuid>%s)/delete/$' % UUID_REGEX,
