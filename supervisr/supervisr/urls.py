...
urlpatterns = [
    ...
    url(r'^accounts/reset/$', account.reset_password_init, name='account-reset_password_init'),
    url(r'^accounts/reset/(?P<uuid>[a-z0-9\-]{36})/$', account.reset_password_confirm, name='account-reset_password_confirm'),
