...
from supervisr_puppet import views

urlpatterns = [
    url(r'v3/modules$', views.module_list, name='module-list'),
    url(r'v3/modules/(?P<user>[a-z0-9]+)-(?P<module>[a-z0-9]+)$', views.module, name='module'),
    ...
    url(r'v3/releases/(?P<user>[a-z0-9]+)-(?P<module>[a-z0-9]+)-(?P<version>[a-z0-9\.]+)$',
        views.release, name='release'),
    url(r'v3/files/(?P<user>[a-z0-9]+)-(?P<module>[a-z0-9]+)-(?P<version>[a-z0-9\.]+).tar.gz$',
